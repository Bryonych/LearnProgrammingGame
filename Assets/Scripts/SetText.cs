...
public class SetText : MonoBehaviour {
    ...
    void Update() {
        if (page == 0) {
            ...
            + "\nThe \'int[ ]\' part means it is a list of integers and \'numbers\' is the name of the list."
            ...
            + "barrel from the list using its index number as described. The name of the list is 'barrels'.");
